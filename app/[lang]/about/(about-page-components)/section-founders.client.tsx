      ...
      <section
         ...
         <article
            ...
            <main className={' flex flex-col items-center justify-center gap-2 px-2 md:px-6'}>
               ...
               {activeTab === 'Jerome' && (
                  <TabText className={'flex w-full items-center justify-start gap-1'}>
                     <span>
                        <svg
                           width="15"
                           height="15"
                     ...
                     <Link
                        className={
                           'prose m-0 w-full font-poppins font-light !text-primary opacity-70 text-balance hover:opacity-100'
                        }
